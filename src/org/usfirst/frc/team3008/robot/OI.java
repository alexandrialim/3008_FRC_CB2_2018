...
import org.usfirst.frc.team3008.robot.commands.Sol_CloseCommand;
import org.usfirst.frc.team3008.robot.commands.Sol_OpenCommand;
import org.usfirst.frc.team3008.robot.commands.Sol_StopCommand;
...
public class OI {
	  ...
	  Button DSOpen = new JoystickButton(joy1,5); // LB
	  Button SSClose = new JoystickButton(joy1,6); // RB
	 ...
	 public OI() {
		 ...
		 SSClose.whenInactive(new SingleSol_stopCommand());
		 SSClose.whenPressed(new SingleSol_Command());
	 }
